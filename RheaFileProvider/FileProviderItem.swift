...
class FileProviderItem: NSObject, NSFileProviderItem {
    ...
    // TODO: implement an initializer to create an item from extension's backing model
    // TODO: implement the accessors to return the values from extension's backing model
